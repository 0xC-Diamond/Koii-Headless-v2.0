...
```
## And Now?
- Update the `.env-local` File like its described here in the https://github.com/koii-network/task-template check the file itself: `.env-local` also pause on the video if needed.
